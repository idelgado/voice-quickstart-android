...
public class AppRTCBluetoothManager {
    ...
    private final AudioDeviceChange apprtcAudioManager;
    @Nullable
    ...
    /** Construction. */
    static AppRTCBluetoothManager create(Context context, AudioDeviceChange audioManager) {
        Log.d(TAG, "create" + AppRTCUtils.getThreadInfo());
        return new AppRTCBluetoothManager(context, audioManager);
    }

    protected AppRTCBluetoothManager(Context context, AudioDeviceChange audioManager) {
        Log.d(TAG, "ctor");
